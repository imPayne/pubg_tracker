...
import { Input, Button, Heading, Box, Container, Text, SliderProvider } from '@chakra-ui/react'
        ...
        return (
            <Container mt={25}>
                <Box mt={5} p={7} borderRadius={7} backgroundColor='#F0F0F0'>
                    ...
                    <Text>Rating: {playerContext.rankedStats.data.attributes.rankedGameModeStats["squad-fpp"].currentRankPoint}</Text>
